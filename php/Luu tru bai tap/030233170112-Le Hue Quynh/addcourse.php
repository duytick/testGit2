...
<body>
    ...
    <form id="form1" method="post" action="doaddcourse.php">
        <p>
            ...
            <p class = "error" ><?php if (isset($_POST["Course_code"])) echo $codeErr;?></p></p>
        <p>
            <label for="">Course name: </label>
            <input type="text" name="Course_name" size="55" required value = "<?php if(isset($_POST["Course_name"]))echo $name;?>">
            <p class = "error" ><?php if(isset($_POST["Course_name"])) echo $nameErr;?></p></p>
        <p>
        ...
        <p>
           ...
           <p class = "error" > <?php if(!isset($_POST["instructors"])) ?></p></p>
